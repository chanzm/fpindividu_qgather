...
<body>
    ...
    <div class="container-login100" style="background-image: url('../../../img/home-slider/slider-bg-1.png');">
        <div class="wrap-login100 p-l-5 p-r-5 p-t-80 p-b-30">
            ...
            <form action="../../../dashboard/adm/storepengajuan/{{data.id_request}}" method="post" class="login100-form validate-form" enctype='multipart/form-data'>
                <span class="login100-form-title p-b-37">
                    Add Rekomendasi User
                </span>
             ...
             <div class="wrap-input100 validate-input m-b-20">
                 <input class="input100" type="hidden" name="id_wilayah" id="id_wilayah" value="{{data.id_wilayah}}">
             ...
             <div class="wrap-input100 validate-input m-b-70"><br>
                 <p style="font-size: 16px;color: #4b2354" >Ganti Foto Tempat</p>
                ...
                <div class="container-login100-form-btn">
                	<a href="../../../dashboard/adm/request" class="login100-form-btn" >Cancel</a>
