        ...
        <section class="banner_area">
            <div class="container">
                <div class="row banner_inner_text">
                    <div class="col-md-1">
                        <h4><br></h4>
                        <a href="../../dashboard"><img src="../../img/icon/back.png"></a>
                    </div>
                    <div class="col-md-11">
            ...
            <div class="row">
                <div class="col-lg-12">
                            <div class="text-center">
                                <a class="more_btn" href="../../mintarekom/{{wil.id_wilayah}}">Ajukan Rekomendasi</a>
                    </div>
                </div>
        </div>
                        ...
                        <div class="blog_main_inner">
                            <div class="blog_main_item">
                                ...
                                <div class="blog_text">
                                    ...
                                    <p>{{t.deskripsi}}</p>
                                    <a class="more_btn" href="../../detail/{{t.id_tempat}}">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
