  ...
  public $status; -->  
    ...
    <div class="container-login100" style="background-image: url('../../img/home-slider/slider-bg-1.png');">
        <div class="wrap-login100 p-l-5 p-r-5 p-t-80 p-b-30">
            ...
            <form action="../../mintarekom/{{wil.id_wilayah}}" method="post" class="login100-form validate-form" enctype='multipart/form-data'>
             ...
             <div class="wrap-input100 validate-input m-b-60" data-validate = "Input Menu Tempat">
             	<input class="input100" type="text" name="menu" placeholder="Menu, Ex : (bakso)(ayam)">
             	<span class="focus-input100"></span>
             </div>

             <div class="wrap-input100 validate-input m-b-65"><br>
                ...
                <div class="container-login100-form-btn">
                    <a href="../../dashboard/cek/{{wil.id_wilayah}}" class="login100-form-btn" >Cancel</a>
