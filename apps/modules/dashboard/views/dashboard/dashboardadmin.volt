...
<!--                       <li class="nav-item"><a class="nav-link" href="about-us.html">About Us</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="/dashboard/adm/listusr">List User</a></li>
             ...
             <div class="row feature_inner">
                 <div class="col-lg-4 col-sm-3">
                     <div class="feature_item" style="padding: 10px;box-shadow: 5px 10px;">
                         ...
                         <a class="more_btn" href="dashboard/cekadmin/{{wil1.id_wilayah}}" >Click Here</a>
                     </div>
                 </div>
                 <div class="col-lg-4 col-sm-3">
                     <div class="feature_item" style="padding: 10px;box-shadow: 5px 10px;">
                         ...
                         <a class="more_btn" href="dashboard/cekadmin/{{wil2.id_wilayah}}">Click Here</a>
                     </div>
                 </div>
                 <div class="col-lg-4 col-sm-3">
                     <div class="feature_item" style="padding: 10px;box-shadow: 5px 10px;">
                         ...
                         <a class="more_btn" href="dashboard/cekadmin/{{wil3.id_wilayah}}">Click Here</a>
                     </div>
                 </div>
             </div> 
             ...
             <div class="row feature_inner">
                 <div class="col-lg-6 col-sm-2">
                     <div class="feature_item" style="padding: 10px;box-shadow: 5px 10px;">
                         ...
                         <a class="more_btn" href="dashboard/cekadmin/{{wil4.id_wilayah}}">Click Here</a>
                     </div>
                 </div>
                 <div class="col-lg-6 col-sm-2">
                     <div class="feature_item" style="padding: 10px;box-shadow: 5px 10px">
                         ...
                         <a class="more_btn" href="dashboard/cekadmin/{{wil5.id_wilayah}}">Click Here</a>
                     </div>
                 </div>
             </div> 
